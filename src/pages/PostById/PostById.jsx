...
export const PostById = () => {
  ...
  const isOwnerFunction = () => {
    if ((res?.data?.author[0]?.email == user?.email) && user != null ){
      setIsOwner(true);
    } else {
      setIsOwner(false);
    }
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <FlexDir>
                        <li>
                          <SavePostElement
                            onClick={() => user != null ? addToSaved(id) : navigate("/login")}
                  ...
                  >
                    ...
                    {!isOwner && user == null && (
                      <ConnectButtonCustom onClick={() => navigate("/login")}>
                        Connect
                      </ConnectButtonCustom>
                    )}
                    {isOwner && (
                  ...
                  <FlexDir width="100vw" margin="3vw 0 0 0">
                    ...
                    >
                      ...
                      {res?.data?.room[0]?.commoditiesRoom?.includes(
                        ...
                        <li>
                          {printRoomIcons("Private Bathroom")}Private Room
                        </li>
                      ) : (
                        <li>
                          {printRoomIcons("Private Bathroom")}Shared Bathroom
                        </li>
                      )}
                    </UlCustom>
                  </FlexDir>
